...
public class MediaLib
{
    public static void main()
    {
        ...
        Song song1 =  new Song("Polly", 1.29, 10);
        numSongs = numSongs + 1;
        ...
        Song song2 =  new Song("William Cape", .99, 9);
        numSongs = numSongs + 1;
        ...
        Song song3 =  new Song("SomeThing In The Way", 1.29, 8);
        numSongs = numSongs + 1;
        ...
        Song song4 =  new Song("About a Girl", 99, 7);
        numSongs = numSongs + 1;
        ...
        Song song5 =  new Song("Come As You Are", 1.29, 6);
        numSongs = numSongs + 1;
        ...
        Song song6 =  new Song("Heart-Shaped Box", .99, 7);
        numSongs = numSongs + 1;
        ...
        Song song7 =  new Song("Lithium", 1.29, 8);
        numSongs = numSongs + 1;
        ...
        Song song8 =  new Song("All Apologies", .99, 9);
        numSongs = numSongs + 1;
        ...
        Song song9 =  new Song("Smells Like Teen Spirit", 1.29, 10);
        numSongs = numSongs + 1;
        ...
        Song song10 =  new Song("Sliver", .99, 9);
        numSongs = numSongs + 1;
        ...
        System.out.println("Number Of Songs: "+ song10.getNumSongsInLibrary() 
